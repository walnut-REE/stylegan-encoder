...
def main():
    ...
    parser.add_argument('--model_url', default='./cache/karras2019stylegan-ffhq-1024x1024.pkl',
                        help='load local model -- Jack12')  # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        ...
        with dnnlib.util.open_url('./cache/vgg16_zhang_perceptual.pkl', cache_dir=config.cache_dir) as f:
            perc_model =  pickle.load(f)
